        ...
        div(class = "content-container",
          ...
          div(id = "main-content",
            ...
            conditionalPanel(
              ...
              attritionModuleUI("attrition")
            ),
            
            # Demographics tab
            conditionalPanel(
              condition = "input.selected_tab == 'demographics'",
              demographicsModuleUI("demographics")
            ),
            
            # Performance tab
            conditionalPanel(
              condition = "input.selected_tab == 'performance'",
              performanceModuleUI("performance")
            ),
            ...
            conditionalPanel(
              ...
              satisfactionModuleUI("satisfaction")
            ),
...
server <- function(input, output, session) {
  ...
  sidebar_results <- sidebarModuleServer("sidebar", shared_values, atlas_logger)
  ...
  observe({
    if (!is.null(sidebar_results$filtered_data())) {
      ...
      shared_values$selected_filters <- sidebar_results$selected_filters()
  ...
  overview_results <- overviewModuleServer("overview", shared_values, atlas_logger)
  attrition_results <- attritionModuleServer("attrition", shared_values, atlas_logger)
  demographics_results <- demographicsModuleServer("demographics", shared_values, atlas_logger)
  performance_results <- performanceModuleServer("performance", shared_values, atlas_logger)
  compensation_results <- compensationModuleServer("compensation", shared_values, atlas_logger)
  satisfaction_results <- satisfactionModuleServer("satisfaction", shared_values, atlas_logger)
